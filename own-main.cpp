...
int main(int argc, char* argv[]) {
	...
	if(argument_target_brightness == "max") { target_brightness = 255; argument_flag = true; }
	if(argument_target_brightness == "min") { target_brightness = 1; argument_flag = true; }
	if(argument_target_brightness == "off") { target_brightness = 0; argument_flag = true; }

	if (!argument_flag) target_brightness = std::stoi(argv[1]);
